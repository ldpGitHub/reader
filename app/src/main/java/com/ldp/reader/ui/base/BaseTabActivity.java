...
// */
//
//public abstract class BaseTabActivity<VB extends ViewBinding> extends BaseActivity<VB> {
//
//    /************Params*******************/
...
//
//        TabLayout mTlIndicator = findViewById(R.id.tab_tl_indicator);
//        ViewPager mVp = findViewById(R.id.tab_vp);
